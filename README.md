...
| :------------------- | :-------------- | :----------|
|     V1.0.4         | edgesolution/single-repo:v1.0.4<br />edgesolution/apphub-postgres:v1.0<br />edgesolution/apphub-minio:v1.0 | androiddmnew/androiddm-astore-slim-dev:v3.2.5 <br />eidevice/androiddm-postgres-dev:v1.1<br />eidevice/androiddm-minio-dev:v1.1<br /> |
